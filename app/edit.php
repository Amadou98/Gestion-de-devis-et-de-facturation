<?php 
      ...
      $db = new operations();
       // $db->Update();
      $Idclient = $_GET['U_ID'];
      $result = $db->Obtenir_Enregistrement($Idclient);
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Créer un devis</a>
            <a class="collapse-item" href="#">Consulter un devis</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Formulaire client</h1>
                  ...
                  <div class="container">
                        ...
                        <div class="card mt-2">
                          <div class="card-header">
                            <h2>Mis à jour  d'un client</h2>
                          </div>
                           <?php $db->Update(); ?>
                          <div class="card-body">
                            <form  method="post"  >
                              <input type="hidden" name="idclient" value="<?php echo $donne['idclient']; ?>">
                              <input type="text" name="nom" placeholder="mettez le nom du client" class="form-control mb-2" required value="<?php echo $donne['nom']; ?>">
                              <input type="text" name="adresse" placeholder="mettez l'adresse du client" class="form-control mb-2" required value="<?php echo $donne['adresse']; ?>">
                              <input type="phone" name="telephone" placeholder="mettez le numero du client" class="form-control mb-2" required value="<?php echo $donne['telephone']; ?>">
                              <input type="email" name="email" placeholder="mettez l'email du client " class="form-control mb-2" required value="<?php echo $donne['email']; ?>">
                          </div>
                        <div class="card-footer">
                            <button class="btn btn-success" type="submit" name="btn-update">Mettre à jour </button>
                        </div>
                            </form>
                          </div>
