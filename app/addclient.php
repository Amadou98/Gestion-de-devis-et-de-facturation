                  ...
                  <div class="container">
                        ...
                        <div class="card mt-2">
                          <div class="card-header">
                           ...
                           <?php $db->Enregistrement_Client(); ?>
                          <div class="card-body">
                            <form  method="post" >
                              <input type="text" name="nom" placeholder="mettez le nom du client" class="form-control mb-2" required>
                              <input type="text" name="adresse" placeholder="mettez l'adresse du client" class="form-control mb-2" required>
                              <input type="phone" name="telephone" placeholder="mettez le numero du client" class="form-control mb-2" required>
                              <input type="email" name="email" placeholder="mettez l'email du client " class="form-control mb-2"required>
                          </div>
                        <div class="card-footer">
                            <button class="btn btn-primary" type="submit" name="btn-save">Enregitré</button>
                        </div>
                            </form>
                          </div>
